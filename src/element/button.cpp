...
void ButtonSystem::calculate_size_components(Node &node,
...
void ButtonSystem::render(const Node &node, const NodeState &state,
  ...
  renderers.text.queue_text(
      font, style.text.font_color, element.text, element.max_width,
      node.origin +
