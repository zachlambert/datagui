...
int main() {
  ...
  instances.push_back(Shape2dInstance::rect(
      Vec2(0, 0),
      0.f,
      Vec2(200, 200),
      Color::Red(),
  ...
  // Rounded box
  instances.push_back(Shape2dInstance::box(
  ...
  // Circle
  instances.push_back(Shape2dInstance::circle(
      Vec2(430, 400),
      50,
  ...
  // Rotated ellipse
  instances.push_back(Shape2dInstance::ellipse(
      Vec2(90, 250),
      0.3f,
      Vec2(70, 40),
  ...
  instances.push_back(Shape2dInstance::line(
      Vec2(180, 210),
      Vec2(330, 300),
      12,
      Color::Black(),
  ...
  // Capsule
  instances.push_back(Shape2dInstance::capsule(
      Vec2(390, 210),
      Vec2(460, 300),
      22,
      Color::Gray(0.5f),
